...
Here's the big picture of how everything works together:

![The Story of How It Works](assets/the_story_of_how_it_works.png)

## One Turn (Tick) in Six Beats

> *A hush, a hum, and then the world moves...*

Every day in Spark-World follows the same rhythm—six stages that keep the world alive and tell its story. Here's how it works:

![The 6-Stage Daily Rhythm](assets/the_6_stage_daily_rhythm.png)
...
Every agent in Spark-World is a thinking mind with its own personality and goals. Here's how they make their decisions:

![How Agents Make Decisions](assets/how_agents_make_decisions.png)
...
Here's how the mission system brings agents together:

![The Story of Mission System](assets/the_story_of_mission_system.png)
