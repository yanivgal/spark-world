...
### Mission System
Missions are procedurally generated by an LLM when bonds form. Currently, missions are one-time events - when completed, the bond continues without a mission. Future versions may include new mission generation or different mission types.
